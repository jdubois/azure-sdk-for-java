...
public final class ConfigurationAsyncClient {
    ...
    Mono<PagedResponse<ConfigurationSetting>> listSettingRevisionsFirstPage(SettingSelector selector, Context context) {
        ...
        if (selector != null) {
            ...
            result = service.listKeyValueRevisions(serviceEndpoint, keys, labels, fields, selector.acceptDateTime(),
                range, context)
                ...
                .doOnError(error -> logger.warning("Failed to list ConfigurationSetting revisions - {}", selector,
                    error));
        } else {
