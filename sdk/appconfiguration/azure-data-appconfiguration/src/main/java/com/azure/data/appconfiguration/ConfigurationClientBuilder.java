...
public final class ConfigurationClientBuilder {
     ...
     * #credential(ConfigurationClientCredentials) credential} are set through the builder. Or can be set explicitly by
     * calling {@link #endpoint(String)}.
    ...
    public ConfigurationAsyncClient buildAsyncClient() {
        Configuration buildConfiguration = (configuration == null) ? ConfigurationManager.getConfiguration().clone()
            : configuration;
     ...
     *
     * @param endpoint The URL of the Azure App Configuration instance to send {@link ConfigurationSetting} service
