...
public final class SecretAsyncClient {
    ...
    /**
     * The set operation adds a secret to the key vault. If the named secret already exists, Azure Key Vault creates a
     * new version of that secret. This operation requires the {@code secrets/set} permission.
     *
     ...
     * the newly created secret details when a response is received.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.setSecret#string-string}
     *
     ...
     * operation can only be enabled on a soft-delete enabled vault. This operation requires the {@code secrets/purge}
     * permission.
     *
     * <p><strong>Code Samples</strong></p>
     ...
     * downloaded. This operation requires the {@code secrets/backup} permission.
     *
     * <p><strong>Code Samples</strong></p>
     ...
     * within {@link Flux#flatMap(Function)}.</p> {@codesnippet com.azure.keyvault.secrets.secretclient.listSecrets}
     *
     ...
     * recovery id of each deleted secret when a response is received.</p> {@codesnippet
     * com.azure.keyvault.secrets.secretclient.listDeletedSecrets}
     *
    ...
    /**
     * Gets attributes of all the secrets given by the {@code nextPageLink} that was retrieved from a call to {@link
