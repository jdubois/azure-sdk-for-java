...
public final class SecretClient {
     ...
     * creates a new version of that secret. This operation requires the {@code secrets/set} permission.
     *
     * <p><strong>Code Samples</strong></p>
     ...
     * secret. This operation can then be used to get the full secret with its value from {@code secretBase}.</p>
     * <p><strong>Code Samples</strong></p>
     ...
     * secret
     * returned in the response.</p> //Assuming secret is deleted on a soft-delete enabled key vault.
     ...
     * value included of its latest version.</p> {@codesnippet com.azure.security.keyvault.secretclient.listSecrets}
     *
