...
public final class KeyClient {
     ...
     * EcKeyCreateOptions#expires() expires} and {@link EcKeyCreateOptions#notBefore() notBefore} values are optional.
     * The {@link EcKeyCreateOptions#enabled() enabled} field is set to true by Azure Key Vault, if not specified.</p>
     *
     ...
     * out
     * the details of the created key.</p> {@codesnippet com.azure.keyvault.keys.keyclient.createEcKey#keyOptions}
     *
     ...
     * in {@code keyImportOptions} are optional. If not specified, no values are set for the fields. The {@link
     * KeyImportOptions#enabled() enabled} field is set to true and the {@link KeyImportOptions#hsm() hsm} field is set
     * to false by Azure Key Vault, if they are not specified.</p>
     *
     * <p><strong>Code Samples</strong></p>
     * <p>Imports a new key into key vault. Prints out the details of the imported key.</p>
     * <pre>
     ...
     * </pre>
     *
     * @param keyImportOptions The key import configuration object containing information about the json web key being
     * imported.
     *
     * @return The {@link Key imported key}.
     *
     ...
     * @param version The version of the key to retrieve. If this is an empty String or null, this call is equivalent to
     * calling {@link KeyClient#getKey(String)}, with the latest version being retrieved.
     *
     ...
     * returned in the response.</p> //Assuming key is deleted on a soft-delete enabled key vault.
     ...
     * of its latest version.</p> {@codesnippet com.azure.keyvault.keys.keyclient.listKeys}
     *
     ...
     * key} by page and
     * call {@link KeyClient#getKey(KeyBase baseKey)} . This will return the {@link Key key} with key material included
     * of its latest version.</p> {@codesnippet com.azure.keyvault.keys.keyclient.listKeys.iterableByPage}
     *
     ...
     * and
     * call {@link KeyClient#getKey(KeyBase baseKey)} . This will return the {@link Key key} with key material included
     * of its latest version.</p> {@codesnippet com.azure.keyvault.keys.keyclient.listKeys#Context}
     *
     * <p><strong>Code Samples to iterate keys by page</strong></p>
     * <p>It is possible to get full keys with key material from this information. Iterate over all the {@link KeyBase
     * key} by page and
     ...
     * of the specified versions.</p> {@codesnippet com.azure.keyvault.keys.keyclient.listKeyVersions}
     *
     ...
     * call {@link KeyClient#getKey(KeyBase baseKey)} . This will return the {@link Key keys} with key material included
     * of the specified versions.</p> {@codesnippet com.azure.keyvault.keys.keyclient.listKeyVersions.iterableByPage}
     *
     * @param name The name of the key.
     *
