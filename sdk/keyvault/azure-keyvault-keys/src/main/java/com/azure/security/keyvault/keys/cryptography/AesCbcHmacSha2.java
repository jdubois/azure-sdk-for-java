...
abstract class AesCbcHmacSha2 extends SymmetricEncryptionAlgorithm {
    ...
    static class AesCbcHmacSha2Decryptor implements IAuthenticatedCryptoTransform {
        ...
        AesCbcHmacSha2Decryptor(String name, byte[] key, byte[] iv, byte[] authenticationData,
                                byte[] authenticationTag, Provider provider) throws InvalidKeyException,
        ...
        private static Triplet<byte[], byte[], Mac> getAlgorithmParameters(
            String algorithm, byte[] key) throws InvalidKeyException, NoSuchAlgorithmException {
    ...
    static class AesCbcHmacSha2Encryptor implements IAuthenticatedCryptoTransform {
        ...
        AesCbcHmacSha2Encryptor(
            String name, byte[] key, byte[] iv, byte[] authenticationData, Provider provider)
        ...
        private static Triplet<byte[], byte[], Mac> getAlgorithmParameters(String algorithm, byte[] key)
    ...
    public ICryptoTransform createDecryptor(byte[] key, byte[] iv, byte[] authenticationData,
                                            byte[] authenticationTag) throws InvalidKeyException,
        NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException {
