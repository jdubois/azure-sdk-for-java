 ...
 * <li>Should not use any external logger class, only use ClientLogger. No slf4j, log4j, or other logging imports
 * are allowed.</li>
...
public class GoodLoggingCheck extends AbstractCheck {
    ...
    private void checkLoggerNameMatch(DetailAST varToken) {
        ...
        if (TokenUtil.findFirstTokenByPredicate(varToken, node -> node.getType() == TokenTypes.MODIFIERS
