 ...
 * <ol>
 * <li>Package, class, and method names should be concatenated with a dot '.'.
 * Ex., packageName.className.methodName</li>
 * <li>Methods arguments should be concatenated with a dash '-'.
 * Ex. String-String  for methodName(String s, String s2)</li>
